			...
			switch ( $value['type'] ) {
				...
				case 'images':
					...
					$i++;
						...
						$output .= '<img src="'.$option.'" alt="'. $key .'" class="of-radio-img-img '. $selected .'" onClick="document.getElementById(\'of-radio-img-'. $value['id'] . $i.'\').checked = true;" />';
						$output .= '</span>';
					}
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup : ','organicfood').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
