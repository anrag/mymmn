                ...
                <div id="post-<?php the_ID() ?>" <?php  post_class($columns); ?>>
                    ...
                    if (has_post_thumbnail()){
                        ...
                        if($crop_image == true || $crop_image == 1){                                            
                            ...
                            echo '<div class="cs-testimonial-featured-img-style2"><img class="attachment-featuredImageCropped" src="'. esc_attr($image_resize['url']) .'" /><span class="circle-border"></span></div>';
                        }else{
