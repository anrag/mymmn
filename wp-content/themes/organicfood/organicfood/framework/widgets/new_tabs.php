<?php
class CS_New_Tabs_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'cs_new_tabs_widget', // Base ID
                __('New Tabs', 'organicfood'), // Name
                array('description' => __('New Tabs Widget', 'organicfood'),) // Args
        );
    }
            ...
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs">
                    <?php if ($show_popular_posts == 'true'): ?>
                        <li class="active"><a href="#tab1" data-toggle="tab"><?php echo __('Popular', 'organicfood'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_recent_posts == 'true'): ?>
                        <li><a href="#tab2" data-toggle="tab"><?php echo __('Recent', 'organicfood'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_comments == 'true'): ?>
                        <li><a href="#tab3" data-toggle="tab"><?php echo __('Comments', 'organicfood'); ?></a></li>
                    <?php endif; ?>
                </ul>
                                    ...
                                    <?php while ($popular_posts->have_posts()): $popular_posts->the_post(); ?>
                                        <li>
                                            ...
                                            <div class="cs-details table-cell">
                                                ...
                                                <div class="description"><?php echo custom_excerpt( 10, '...'); ?></div>
                                            </div>
                                        </li>
                                    <?php endwhile; ?>
                                </ul>
                                ...
                                foreach ($the_comments as $comment) {
                                    ...
                                    <li>
                                        ...
                                        <div class="post-holder table-cell">
                                            ...
                                            <div class="meta">
                                                <a class="comment-text-side" href="<?php echo get_permalink($comment->ID); ?>#comment-<?php echo $comment->comment_ID; ?>" title="<?php echo strip_tags($comment->comment_author); ?> on <?php echo $comment->post_title; ?>"><?php echo $comment->com_excerpt; ?>...</a>
                                            </div>
                                        </div>
                                    </li>
                                <?php } ?>
...
/**
 * Class CS_New_Tabs_Widget
 */
function register_new_tabs_widget() {
    register_widget('CS_New_Tabs_Widget');
}
