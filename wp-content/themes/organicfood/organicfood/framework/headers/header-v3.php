...
<div class="header header-v3">
            ...
            <div class="row"> 
                <div class="header-top clearfix">
                    ...
                    --><div class='header-top-2 col-xs-12 col-sm-6 col-md-8 col-lg-8 aligncenter-sm'>
                        <?php
                        if (!function_exists('dynamic_sidebar') || !dynamic_sidebar("Header 3 Top Widget 1")):
                        endif;
                        ?>
                    </div>
                </div>
    ...
    <header id="cshero-header">
        ...
        <div class="container">
        <div class="row">
            <div class='widget1_wrap col-xs-12 col-sm-6 col-md-8 col-lg-8'>
                ...
                <div class='widget2_wrap col-xs-12 col-sm-6 col-md-4 col-lg-4 aligncenter-sm'>
                    <?php
                        if (!function_exists('dynamic_sidebar') || !dynamic_sidebar("Header 3 Top Widget 2")):
                        endif;
                    ?>
                </div>
            </div>
