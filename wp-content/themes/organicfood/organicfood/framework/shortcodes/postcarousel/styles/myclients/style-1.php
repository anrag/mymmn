...
?>
<div  id="ww_carousel_client<?php echo esc_attr($date); ?>" class="cs-carousel <?php echo $same_height ? 'sameheight' : ''; ?> slider-post <?php echo esc_attr($cl_show) . ' ' . esc_attr($el_class); ?>">          
    <div class="cs-content">        
        <div class="cs-carousel-list">
            <div id="cs_carousel_client_<?php echo esc_attr($date); ?>" data-moveslides="1" data-auto="<?php echo esc_attr($auto_scroll); ?>" data-prevselector="#ww_carousel_client<?php echo esc_attr($date); ?> .bx-prev" data-nextselector="#ww_carousel_client<?php echo $date; ?> .bx-next" data-onsliderload="<?php echo esc_attr($onload); ?>" data-touchenabled="1" data-controls="true" data-pagerselector="#ww_carousel_client<?php echo esc_attr($date); ?> .wp-controls" data-pager="<?php echo esc_attr($show_pager);?>" data-pause="4000" data-infiniteloop="true" data-adaptiveheight="true" data-speed="<?php echo esc_attr($speed_scroll); ?>" data-autohover="true" data-slidemargin="<?php echo esc_attr($margin_item); ?>" data-maxslides="6" data-minslides="1" data-slidewidth="<?php echo esc_attr($width_item); ?>" data-slideselector="" data-easing="swing" data-usecss="" data-resize="1" class="slider jm-bxslider">
                <?php
                $counter = 0;
                while ($wp_query->have_posts()) : $wp_query->the_post();
                    ...
                    <div class="cs-carousel-item" <?php if (!$counter % $rows == 0) echo 'style="margin-bottom:' . esc_attr($margin_item) . 'px;"'; ?>>
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <div class="cs-carousel-container text-center">
                                <div title="<?php the_title(); ?>" <?php if($show_tooltip) echo 'data-uk-tooltip="post: top"' ?>>
                                    <?php
