...
?>
<div id="ww_carousel_tesimonial<?php echo esc_attr($date); ?>" class="cs-carousel-tesimonial <?php echo $same_height?'sameheight':'';?> cs-carousel-post-default1 <?php echo esc_attr($cl_show).' '.esc_attr($el_class); ?>">
        <div class="cs-content">
            <div class="cs-carousel-list">
                <div id="cs_carousel_tesimonial_<?php echo esc_attr($date); ?>" data-moveslides="1" data-auto="<?php echo esc_attr($auto_scroll); ?>" data-prevselector="#ww_carousel_tesimonial<?php echo esc_attr($date); ?> .bx-prev" data-nextselector="#ww_carousel_tesimonial<?php echo esc_attr($date); ?> .bx-next" data-onsliderload="<?php echo esc_attr($onload);?>" data-touchenabled="1" data-controls="true" data-pagerselector="#ww_carousel_tesimonial<?php echo esc_attr($date); ?> .wp-controls" data-pager="<?php echo esc_attr($show_pager);?>" data-pause="4000" data-infiniteloop="true" data-adaptiveheight="true" data-speed="<?php echo esc_attr($speed_scroll); ?>" data-autohover="true" data-slidemargin="<?php echo esc_attr($margin_item); ?>" data-maxslides="4" data-minslides="1" data-slidewidth="<?php echo esc_attr($width_item);?>" data-slideselector="" data-easing="swing" data-usecss="" data-resize="1" class="slider jm-bxslider">
                    <?php
                    $counter =0;
